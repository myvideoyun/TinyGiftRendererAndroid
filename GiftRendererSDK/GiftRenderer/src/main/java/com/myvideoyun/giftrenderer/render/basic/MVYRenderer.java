package com.myvideoyun.giftrenderer.render.basic;
...
public class MVYRenderer {
    ...
    public void setCallback(EffectMessageCallback callback) {
    ...
    native void Callback(long renderer, EffectMessageCallback callback);
    ...
    public interface EffectMessageCallback {
        void onMessageCallback(int type, int ret, String info);
    }
}
