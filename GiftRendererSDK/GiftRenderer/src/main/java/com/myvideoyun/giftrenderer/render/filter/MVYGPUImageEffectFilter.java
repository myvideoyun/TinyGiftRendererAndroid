...
import static com.myvideoyun.giftrenderer.render.basic.MVYRenderer.MSG_STAT_EFFECTS_END;

public class MVYGPUImageEffectFilter extends MVYGPUImageFilter implements MVYRenderer.EffectMessageCallback {
    ...
    @Override
    public void onMessageCallback(int type, int ret, String info) {
